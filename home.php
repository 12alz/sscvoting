...
// End Of Check ##############################################s
$(function() {
    // Apply custom styling to checkboxes and radio buttons
    $('.content').iCheck({
        checkboxClass: 'icheckbox_flat-green',
        radioClass: 'iradio_flat-green'
    });

    // Handle resetting vote selection for each position
    ...
    // Handle the candidate platform modal
    ...
    // Handling the preview button click
    ...
    // Handle vote switching for single selection (radio buttons)
    $('input[type="radio"]').on('change', function() {
        var position = $(this).attr('name');  // Name of the radio button group (position)
        
        // Uncheck all other radio buttons for the same position group if the user selects another candidate
        $('input[name="' + position + '"]').not(this).iCheck('uncheck');
    });
});
