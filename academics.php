                            ...
                            <ul class="col-lg-3">
                              <li>
                                ...
                                <ul class="list-unstyled offset-lg-top-20">
                                  ...
                                  <li><a href="privacy-policyp">Privacy Policy</a></li>
        ...
        <div class="container">
          <div class="tabs-custom tabs-vertical tabs-line tabs-line-1" id="tabs-7">
            ...
            <ul class="nav nav-tabs">
              <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-7-1" data-bs-toggle="tab">Bachelor of Science in Infomation Technology</a></li>
              <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-7-2" data-bs-toggle="tab">Bachelor of Science in Business Administration</a></li>
