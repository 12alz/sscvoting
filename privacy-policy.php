                    ...
                    <ul class="list-unstyled">
                      ...
                      <li>
                        <div class="unit flex-row align-items-center unit-spacing-xs">
                          ...
                          <div class="unit-body"><a href="mailto:#">isscmcc13@gmail.com</a></div>
                        </div>
                      </li>
                    </ul>
                  </div>
            ...
            <div class="col-sm-10 col-md-8">
              <div class="row row-60">
                <div class="col-12">
                  ...
                  <p>Welcome to our Privacy Policy page! When you use our , you trust us with your information. This Privacy Policy is meant to help you understand what data we collect, why we collect it, and what we do with it. When you share information with us, we can make our services even better for you. For instance, we can show you more relevant search results and ads, help you connect with people or to make sharing with others quicker and easier. As you use our services, we want you to be clear how we`re using information and the ways in which you can protect your privacy. This is important; we hope you will take time to read it carefully. Remember, you can find controls to manage your information and protect your privacy and security. We`ve tried to keep it as simple as possible.</p>
                </div>
                <div class="col-12">
              ...
              <div class="offset-top-30"><a class="btn button-primary" href="contacts.html">Contact Us</a></div>
            </div>
          </div>
        </div>
      </section>
