        ...
        <div class="container text-start">
          <div class="row row justify-content-sm-center">
            <div class="col-sm-10 col-md-8">
              ...
              <div class="offset-top-30"><a class="btn button-primary" href="contacts">Contact Us</a></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container section-xs block-after-divider">
          <div class="row row-50 justify-content-xl-between justify-content-sm-center">
            <div class="col-lg-3 col-xl-2">
              <!--Footers brands--><a class="d-inline-block" href="index"><img width='170' height='172' src='images/logo-170x172.png' alt=''/>
                <div>
