...
<html class="wide wow-animation scrollTo" lang="en">
  <head>
    <!-- Site Title-->
    <title>Classic news</title>
    <meta charset="utf-8">
    <meta name="format-detection" content="telephone=no">
    <meta name="viewport" content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="keywords" content="PAgka libug namn gayud">
            ...
            <div class="col-lg-8 text-lg-start row-30">
              ...
              <article class="post-news post-news-wide"><a href="news-post-page"><img class="img-responsive w-100" src="images/classicnews3.jpg" width="770" height="500" alt=""></a>
                <div class="post-news-body">
                  ...
                  <div class="offset-top-20">
                    <p>We are pleased to inform all of you that the Office of the Scholarship will be conducting ID Capturing for your official student identification cards.</p>
                  </div>
                  <div class="offset-top-20">
                    <ul class="post-news-meta list list-inline list-inline-xl">
              ...
              <div class="offset-top-60 text-lg-start">
                ...
                <nav aria-label="Page navigation">
                  <ul class="pagination pagination-custom">
                    <li class="page-item page-item-control disabled"><a class="page-link" aria-label="Previous"><span class="icon fa fa-chevron-left" aria-hidden="true"></span></a></li>
                    <li class="page-item active"><span class="page-link">1</span></li>
                    <li class="page-item page-item-control"><a class="page-link" aria-label="Next"><span class="icon fa fa-chevron-right" aria-hidden="true"></span></a></li>
                  </ul>
                </nav>
              </div>
            </div>
            ...
            <div class="col-lg-4 text-start col-sm-8">
              <aside class="inset-lg-left-30">
                      ...
                      <div class="fb-page-responsive">
                        <div class="fb-page" data-href="https://www.facebook.com/madridejoscollege" data-tabs="timeline" data-height="500" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                          <div class="fb-xfbml-parse-ignore">
                            <blockquote cite="https://www.facebook.com/madridejoscollege"><a href="https://www.facebook.com/madridejoscollege">TemplateMonster</a></blockquote>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="offset-top-60">
                  ...
                  <div class="text-subline"></div>
                  <div class="offset-top-20">
                    <div class="tags-list group group-sm d-inline-block align-middle"><a class="btn btn-xs button-primary fst-italic" href="news-post-page.php">News</a><a class="btn btn-xs button-primary fst-italic" href="news-post-page.php">Colleges</a><a class="btn btn-xs button-primary fst-italic" href="news-post-page.php ">Education</a></div>
                  </div>
                </div>
              </aside>
            </div>
