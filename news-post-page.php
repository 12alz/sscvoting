        ...
        <nav class="rd-navbar rd-navbar-default">
          <div class="rd-navbar-inner">
            ...
            <div class="rd-navbar-panel">
              ...
              <h4 class="panel-title d-lg-none">Latest News</h4>
                  ...
                  <ul class="list-unstyled">
                    <li>
                      <div class="unit flex-row align-items-center unit-spacing-xs">
                        ...
                        <div class="unit-body"><a href="tel:#">1-800-1234-567,</a> <a class="d-block d-lg-inline-block" href="tel:#">1-800-6547-321</a></div>
                      </div>
                    </li>
                    <li>
                      <div class="unit flex-row align-items-center unit-spacing-xs">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li><a href="#">News</a>
                      <ul class="rd-navbar-dropdown">
                        ...
                        <li><a href="grid-news-3-columns.html">3 Column Grid News</a></li>
                        <li><a href="modern-news.html">Modern News</a></li>
